...
|---|---|---|---|
| [JML Lifecycle Automation](https://github.com/khalxd/jml-lifecycle-automation-lab) | One script that handles the whole employee lifecycle: new hires, department moves, and offboarding, pulling from an HR file and logging every action | Entra ID, PowerShell, Microsoft Graph API, PIM | Complete |
